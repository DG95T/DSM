...
class InterfazTkinter:
    def __init__(self, ventana):
        ...
        self.registro = RegistroPacientes()
    ...
    def crear_botones(self):
        ...
        btn_buscar = tk.Button(self.ventana, text="Buscar Paciente", command=self.buscar_paciente)
    ...
    def buscar_paciente(self):
        id_busqueda = simpledialog.askinteger("Buscar Paciente", "ID del Paciente:")
        paciente = self.registro.buscar_paciente(id_busqueda)
        if paciente:
